...
enum ACTION {MOVE,TEXT,FILEDATA,MOVING,UNDO,REDO,NEWGAME,SYNC,NOTACCEPTED,ACCEPTED,RESIGN_REQUEST, RESIGN_ACCEPT, RESIGN_REJECT, DRAW_REQUEST,DRAW_REJECT,DRAW_ACCEPT,CLEAR_REQUEST,CLEAR_ACCEPT,CLEAR_REJECT};
...
#define HUMAN_HAMAN_MANUAL		2
#define HUMAN_HAMAN_COMPUTER	3
#define SINGLE_PLAY_HUMAN		4
#define SINGLE_PLAY_COMPUTER	5
